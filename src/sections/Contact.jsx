...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "ashwin.dhakal007@gmail.com",
    href: "mailto:ashwin.dhakal007@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+977 9824747665",
    href: "tel:+9779824747665",
  },
  {
    icon: MapPin,
    label: "Location",
...
export const Contact = ({ mode }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Make sure the below error never happens in production or final product
